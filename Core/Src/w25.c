...
#ifdef W25QXX_DEBUG
    Report(NULL, true, "w25qxx CheckPage:0x%X(%u), Offset:%u, Bytes:%u begin...\r\n",
...
#ifdef W25QXX_DEBUG
    Report(NULL, true, "w25qxx CheckPage is Empty in %u ms\r\n", HAL_GetTick() - StartTime);
    //W25qxx_Delay(100);
#endif
...
#ifdef W25QXX_DEBUG
	Report(NULL, true, "w25qxx CheckPage is Not Empty in %u ms\r\n", HAL_GetTick() - StartTime);
	W25qxx_Delay(100);
#endif
...
#ifdef W25QXX_DEBUG
    Report(NULL, true, "w25qxx CheckSector:0x%X(%u), Offset:%u, Bytes:%u begin...\r\n",
...
#ifdef W25QXX_DEBUG
    Report(NULL, true, "w25qxx CheckBlock:0x%X(%u), Offset:%u, Bytes:%u begin...\r\n",
...
#ifdef W25QXX_DEBUG
    Report(NULL, true, "w25qxx CheckBlock is Empty in %u ms\r\n", HAL_GetTick() - StartTime);
    //W25qxx_Delay(100);
#endif
...
#ifdef W25QXX_DEBUG
	Report(NULL, true, "w25qxx CheckBlock is Not Empty in %u ms\r\n", HAL_GetTick() - StartTime);
	//W25qxx_Delay(100);
#endif
...
void W25qxx_WriteByte(uint8_t pBuffer, uint32_t WriteAddr_inBytes)
{
    ...
    //W25qxx_Spi(pBuffer);
    HAL_SPI_Transmit(portFLASH, uk, len, 100);
    W25_UNSELECT();

    W25qxx_WaitForWriteEnd();

#ifdef W25QXX_DEBUG
    Report(NULL, true, "%s done after %d ms\r\n", __func__, HAL_GetTick() - StartTime);
#endif
...
void W25qxx_WritePage(uint8_t *pBuffer, uint32_t Page_Address, uint32_t OffsetInByte, uint32_t NumByteToWrite_up_to_PageSize)
{
    ...
    if (w25_withDMA) {
    	...
    	HAL_SPI_TransmitReceive(portFLASH, pageTmp, pageTmp, sizeof(pageTmp), 250);
    	W25_UNSELECT();
...
#ifdef W25QXX_DEBUG
    Report(NULL, true, "%s WriteBlock:0x%X(%u), Offset:%u ,Write %u Bytes, begin...\r\n",
...
#ifdef W25QXX_DEBUG
    uint32_t StartTime = HAL_GetTick();
    Report(NULL, true, "%s at address %u begin...\r\n", __func__, Bytes_Address);
#endif
...
#ifdef W25QXX_DEBUG
    Report(NULL, true, "%s 0x%02X done after %u ms\r\n", __func__, *pBuffer, HAL_GetTick() - StartTime);
#endif
...
#ifdef W25QXX_DEBUG
    uint32_t StartTime = HAL_GetTick();
    Report(NULL, true, "%s at Address:0x%X(%u), %u Bytes  begin...\r\n",
...
void W25qxx_ReadPage(uint8_t *pBuffer, uint32_t Page_Address, uint32_t OffsetInByte, uint32_t NumByteToRead_up_to_PageSize)
{
    ...
    if (w25_withDMA) {
    	...
    	HAL_SPI_TransmitReceive(portFLASH, pageTmp, pageTmp, sizeof(pageTmp), 200);
